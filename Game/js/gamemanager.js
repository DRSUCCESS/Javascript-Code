...
let GameManager = {
    ...
    resetPlayer: function (classType) {
        ...
        getInterface.innerHTML = '<img src="img/avatar-players/' + 
            classType.toLowerCase() + '.png" class="img-avatar"><div><h3>' + classType 
            + '</h3><p class="health-player">Health:' + player.health + '</p><p>Mana:' + player.mana + '<p>Strength:' 
    ...
    setFight: function() {
        ...
        let enemy01 = new Enemy("Troll", 150, 80, 150, 80, 150);
        ...
        getEnemy.innerHTML = '<img src="img/avatar-enemies/' +
            enemy.enemyType.toLowerCase() + '.jpeg" alt="' + enemy.enemyType + 'class="img-avatar"><div><h3>' + enemy.enemyType
            + '</h3><p class="health-enemy">Health:' + enemy.health + '</p><p>Mana:' + enemy.mana + '<p>Strength:'
